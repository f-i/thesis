...
them, e.g.\ combining a fixed hotspot frame from 100 Ma to 0 Ma~\cite{M93} with
a moving hotspot frame from c. 132\textendash100 Ma~\cite{O05} (Hybrid hotspot
model~\cite{Sh12}), combining a moving hotspot frame from 100\textendash0
...
symmetry of the Earth's magnetic dipole field)~\cite{T08} from 140\textendash100
Ma (Hybrid paleomagnetic model~\cite{Sh12}), and combining a moving hotspot
frame from 120\textendash100 Ma~\cite{O05} with a True Polar Wander (TPW)
corrected paleomagnetic model~\cite{S08} from 100\textendash0 Ma (Hybrid
