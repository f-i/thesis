...
\begin{figure}
    \centering
        \includegraphics[width=0.88\textwidth]{../sphinx/source/I/fig/dipole.jpg}
...
\begin{figure*}[tbp]
  ...
  \begin{subfigure}[htbp]{.49\textwidth}
    \centering
    \includegraphics[width=1.01\linewidth]{../sphinx/source/I/fig/nac5052.pdf}
    \caption{52 Ma to 50 Ma (mean age).}\label{Fig:chap_intro_nac5052agemean}
  \end{subfigure}
  \begin{subfigure}[htbp]{.49\textwidth}
    \centering
    \includegraphics[width=1.01\linewidth]{../sphinx/source/I/fig/nac2830.pdf}
  ...
  ellipses are 95\% confidence errors.}\phantomsection\label{Fig:chap_intro_ma-amp}
\end{figure*}
