...
a moving-hotspot frame from ${\sim}132$\textendash100
Ma~\citep{O05}~\citep[Hybrid hotspot model, see][]{Sh12}, combining a
moving-hotspot frame from 100\textendash0 Ma~\citep{O05} with a paleomagnetic
...
dipole field)~\citep{T08} from 140\textendash100 Ma~\citep[Hybrid paleomagnetic
model, see][]{Sh12}, and combining a moving-hotspot frame from 120\textendash100
Ma~\citep{O05} with a true polar wander (TPW) corrected paleomagnetic
model~\citep{S08} from 100\textendash0 Ma~\citep[Hybrid TPW-corrected model,
see][]{Sh12}.
...
reasonably and reliably. We can test this by looking at the last 0\textendash120
...
\bigskip
In summary, this thesis might not be able to help fully answer all the above
questions. However, in the end the completion of this thesis and attempts of
solving these questions are hoped to be inspirational in creating better
methodologies and asking and solving more interesting questions.
