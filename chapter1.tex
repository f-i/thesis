...
\begin{figure}
    \centering
        \includegraphics[width=1\textwidth]{/home/g/Desktop/git/pps/poster/fig/na.pdf}
    \captionsetup{width=.95\textwidth}
    ...
    of all published paleomagnetic poles of the NAC over time, which are
	compiled from GPMDB 4.6b and PALEOMAGIA.}\label{Fig:chap_intro_nacpole}
\end{figure}
