...
(Fig.~\ref{fig:LauruG},~\subref{fig:LGl},~\subref{fig:LGa}) are actually higher
...
(Fig.~\ref{fig:LauruG},~\subref{fig:LGlS},~\subref{fig:LGaS}). Therefore, the
...
(Fig.~\ref{fig:LauruG},~\subref{fig:LGs},~\subref{fig:LGsS}). Comparison of the changes in
