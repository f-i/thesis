...
\usepackage{amssymb,booktabs,gensymb,url,textcomp,amsmath}
\usepackage[nohints]{minitoc}
\setcounter{minitocdepth}{2}
\usepackage[font=small,labelfont=bf,belowskip=-15pt,aboveskip=5pt]{caption} %setup globally
...
\usepackage[xcdraw]{xcolor}  %colorful words in tables
...
\degreen{Doctor of Philosophy}     %the degree
\degreedate{Someday 2020}         %the degree date
