...
\begin{figure}
  ...
  \caption[Distribution of 120\textendash0 Ma North American
    ...
    bars; only two poles, 83\textendash77 Ma and 80\textendash65 Ma, from
    igneous and also sedimentary; only one pole, 72\textendash40 Ma, from
    ...
    two poles, 146\textendash65 Ma [RESULTNO 6679] and 2\textendash0 Ma
...
\begin{figure}
  ...
  \caption[$\mathcal{CPD}$ of each plate's paleomagnetic APWPs vs its FHM
    ...
    coded.}\label{fig-dif} % caption for whole figure
\end{figure}
...
\begin{figure*}
  ...
  \begin{subfigure}{1.01\textwidth}
    ...
    \caption{North America: minimum 0.00565784 (5(1)), maximum 0.104618 (14(2)),
  ...
  \begin{subfigure}{1.01\textwidth}
    ...
    \caption{India: minimum 0.0177 (6(3)), maximum 0.15937 (16(1)), mean 0.0745,
      median 0.061346}\label{fig-in-dif2010m}
  \end{subfigure}
  \vspace{.1em}
  \begin{subfigure}{1.01\textwidth}
    \includegraphics[width=\textwidth]{../../paper/tex/GeophysJInt/figures/801_20_10_120_0m.pdf}
    \caption{Australia: minimum 0.00282 (23(4)), maximum 0.31998 (22(3)), mean
      0.062766, median 0.02803}\label{fig-au-dif2010m}
  \end{subfigure}
  \caption[$\mathcal{CPD}$ of each plate's paleomagnetic APWPs vs its MHM
    predicted APWP (20/10 Myr window/step)]{As Fig.~\ref{fig-dif2010}, here the
    reference path is predicted from MHM\@. See the numbers of picked paleopoles
    in Fig.~\ref{fig-dif}.}\label{fig-dif2010m}
\end{figure*}
...
\begin{figure}
  \centering
  \includegraphics[width=1\textwidth]{../../paper/tex/GeophysJInt/figures/draper.pdf}
...
from Wt 1\textendash5 to result from 0 are generally in the second quadrant of
...
the five weightings (Wt 1\textendash5) do make effects, not obviously in
...
not colored in green, but ranging from 0.0483\textendash0.0561 that is still
