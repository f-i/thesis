...
\begin{figure}
    ...
    \caption{Comparisons of results from Pk 1 (APP) and Pk 0
	(AMP) with all the listed weighting methods for three continents. The
	$Q_1$\textendash$Q_3$ interquartile range from Pk 1 is also shown
	(shadowed) in the plot of Pk 0 for clarity.}\label{Fig:Fay18_10_5_101appamp}
\end{figure}
