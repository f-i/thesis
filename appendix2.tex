...
\begin{figure}
  \centering
  \includegraphics[width=1\textwidth]{../../paper/tex/GeophysJInt/figures/draper1.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=1\textwidth]{../../paper/tex/GeophysJInt/figures/draper2.pdf}
  \caption[Regression of $\mathcal{CPD}$ on average number of paleopoles per
...
\begin{figure}
  \centering
  \includegraphics[width=1\textwidth]{../../paper/tex/GeophysJInt/figures/draper3.pdf}
  \caption[Regression of $\mathcal{CPD}$ on average number of paleopoles per
...
\begin{figure}
  \centering
  \includegraphics[width=1\textwidth]{../../paper/tex/GeophysJInt/figures/draper4.pdf}
  \caption[Regression of $\mathcal{CPD}$ on average number of paleopoles per
...
\begin{figure}
  \centering
  \includegraphics[width=1\textwidth]{../../paper/tex/GeophysJInt/figures/draper5.pdf}
  \caption[Regression of $\mathcal{CPD}$ on average number of paleopoles per
